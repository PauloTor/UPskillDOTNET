...
namespace testProject
{
    class APICentralContextMocker
    {
        ...
        public static void Seed()
        {
            ...
            dbContext.Fatura.Add(new Fatura(DateTime.Parse("2020-01-04 21:00:00"), 32, 1));
            dbContext.Fatura.Add(new Fatura(DateTime.Parse("2021-01-01 20:00:00"), 14, 2));
            dbContext.Fatura.Add(new Fatura(DateTime.Parse("2019-02-11 21:00:00"), 1, 3));
