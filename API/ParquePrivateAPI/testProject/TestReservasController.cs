...
namespace testProject
{
    public class TestReservasController
    {
        ...
        public async Task GetAllReservasAsync_ShouldReturnAllReservasAsync()
        {
            Thread.Sleep(2000);
            //Arrange
            var testContext = ParquePrivateAPIContextMocker.GetParquePrivateAPIContext("DBTest4GetAllReservas");
        ...
        public async Task PostReservas_ShouldCreateReservaAsync()
        {
            Thread.Sleep(3200);
            //Arrange
            var testContext = ParquePrivateAPIContextMocker.GetParquePrivateAPIContext("DBTest4PostReservas");
        ...
        public async Task PutReservabyIDAsync_ShouldUpdateReserva1Async()
        {
            Thread.Sleep(2300);
            //Arrange
            var testContext = ParquePrivateAPIContextMocker.GetParquePrivateAPIContext("DBTest4PutReservaByID");
            var testController = new ReservasController(testContext);
        ...
        public async Task DeleteReservabyIDAsync_ShouldDeleteReserva1Async()
        {
            Thread.Sleep(3400);
            //Arrange
            var testContext = ParquePrivateAPIContextMocker.GetParquePrivateAPIContext("DBTest4DeleteReserva");
            var testController = new ReservasController(testContext);
