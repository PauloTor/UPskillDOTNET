...
namespace testProject
{
    class ParquePrivateAPIContextMocker
    {
        ...
        public static void Seed()
        {
            ...
            dbContext.Parque.Add(new Parque { ParqueID = 1, NomeParque = "Boavista Park", Lotacao = 5, MoradaID = 1});
            dbContext.Parque.Add(new Parque { ParqueID = 2, NomeParque = "Avenida dos Aliados Park", Lotacao = 5, MoradaID = 2});
            dbContext.Lugar.Add(new Lugar { LugarID = 1, Fila = 1, Sector = 1 , Preço = 5, ParqueID = 1});
            dbContext.Lugar.Add(new Lugar { LugarID = 2, Fila = 2, Sector = 1, Preço = 6, ParqueID = 1 });
            dbContext.Lugar.Add(new Lugar { LugarID = 3, Fila = 1, Sector = 2, Preço = 7, ParqueID = 1 });
            dbContext.Lugar.Add(new Lugar { LugarID = 4, Fila = 2, Sector = 1, Preço = 8, ParqueID = 1 });
            dbContext.Lugar.Add(new Lugar { LugarID = 5, Fila = 1, Sector = 1, Preço = 9, ParqueID = 1 });
            dbContext.Lugar.Add(new Lugar { LugarID = 6, Fila = 2, Sector = 1, Preço = 5, ParqueID = 2 });
            dbContext.Lugar.Add(new Lugar { LugarID = 7, Fila = 2, Sector = 2, Preço = 6, ParqueID = 2 });
            dbContext.Lugar.Add(new Lugar { LugarID = 8, Fila = 2, Sector = 1, Preço = 7, ParqueID = 2 });
            dbContext.Lugar.Add(new Lugar { LugarID = 9, Fila = 2, Sector = 2, Preço = 8, ParqueID = 2 });
            dbContext.Lugar.Add(new Lugar { LugarID = 10, Fila = 2, Sector = 1, Preço = 9, ParqueID = 2 });
