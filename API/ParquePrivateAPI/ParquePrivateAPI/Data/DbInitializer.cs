    ...
    public static class DbInitializer
    {
        public static void Initialize(ParquePrivateAPIContext context)
        {
           ...
           // ===============================================================
            ...
            new Parque { NomeParque = " Boavista Park",  MoradaID = 1 },
            new Parque { NomeParque = " Nice Parking",  MoradaID = 2 },
            new Parque { NomeParque = " Parking da cidade", MoradaID = 2 },
            new Parque { NomeParque = " West Parking", MoradaID = 3 },
            new Parque { NomeParque = " North Parking", MoradaID = 4 },
            new Parque { NomeParque = " Souith Parking", MoradaID = 2 },
            new Parque { NomeParque = " East Parking",  MoradaID = 1 }
             };
