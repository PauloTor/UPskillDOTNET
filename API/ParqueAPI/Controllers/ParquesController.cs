...
namespace ParqueAPI.Controllers
{
    public class ParquesController : Controller
    {
        ...
        {
            var parqueAPIContext = _context.Parque.Include(p => p.Morada);
            return View(await parqueAPIContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ParqueID,NomeParque,ParquePublico,MoradaID")] Parque parque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ParqueID,NomeParque,ParquePublico,MoradaID")] Parque parque)
        {
