...
namespace ParqueAPICentral.Data
{
    ...
    public static class DbInitializer
    {
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            //var user = new User_[]
            //{
            //  new User_ { FirstName = "Test1", LastName = "User11", Username = "test1", Password = "test1" },
            //  new User_ { FirstName = "Test2", LastName = "User22", Username = "test2", Password = "test2" },
            //  new User_ { FirstName = "Test3", LastName = "User33", Username = "test3", Password = "test3" },
            //  new User_ { FirstName = "Test4", LastName = "User44", Username = "test4", Password = "test4" },
            //  new User_ { FirstName = "Test5", LastName = "User55", Username = "test5", Password = "test5" }
            //};

            //foreach (User_ s in user)
            //{
            //    context.User_.Add(s);
            //}
            //context.SaveChanges();
